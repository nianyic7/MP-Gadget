...
void measure_power_spectrum(PetaPM * pm, int64_t k2, int kpos[3], cufftDoubleComplex *value);

/* Compute the power spectrum of the Fourier transformed grid in value.*/
void powerspectrum_add_mode(Power * PowerSpectrum, const int64_t k2, const int kpos[3], cufftDoubleComplex * const value, const double invwindow, double Nmesh);
